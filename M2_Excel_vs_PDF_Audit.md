...
| A6 | **Soft-dependency policy** — every NoSQL call must `try/catch + log.warn` and not roll back the upstream PG transaction. Specifically, `MongoEventLogger` must swallow Mongo exceptions. | §3.3 p. 8, §6.3 p. 23 | Not assigned. | Cross-cutting; should be in CC-5/CC-6 owner's brief or every Observer owner's row. |
