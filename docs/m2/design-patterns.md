# M2 Design Patterns — Locations & Grader Hooks

Source of truth: `Uber_descriptionM2.pdf` §3 + §4.5 (M1 retrofits). The auto-grader uses **reflection** (class structure assertions) **and** **source/class scans** (greps and class-file inspection) — both must pass.
